...
################################################################################
# WAN 2.1 + InfinityTalk Provisioning Script for ai-dock/comfyui
#
# This is the main entry point for WAN setup on Vast.AI
# Upload this file to ai-dock as the provisioning script
#
# The script will:
# 1. Clone the ComfyUI repo to get lib files
# 2. Source common functions and WAN-specific setup
# 3. Install QoL nodes, WAN models, and custom nodes
################################################################################
...
# Source WAN-specific library
source "$SCRIPT_DIR/lib/wan-install.sh"
